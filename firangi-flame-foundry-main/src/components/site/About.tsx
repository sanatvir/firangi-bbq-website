      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 sm:gap-14 px-4 sm:px-6 lg:grid-cols-2 lg:px-12">
        ...
        >
          ...
          <div className="rounded-2xl sm:rounded-[2.5rem] border border-border bg-card p-6 sm:p-10 text-center">
            <img src={logo} alt="Firangi Barbeque 2.0 Logo - Premium Tandoor Restaurant in Kirti Nagar Delhi" className="mx-auto h-32 w-32 sm:h-44 sm:w-44 object-contain" loading="lazy" />
            <div className="mt-3 sm:mt-4 font-display text-xl sm:text-2xl">Firangi Barbeque <span className="text-accent">2.0</span></div>
        ...
        >
          ...
          <h2 className="mt-3 sm:mt-4 heading-section">
            Welcome to <span className="italic text-accent">Firangi Barbeque 2.0</span>
          </h2>
          <div className="mt-4 sm:mt-6 space-y-3 sm:space-y-4 text-xs sm:text-sm text-muted-foreground">
            <p>
              Your ultimate destination for a delightful culinary experience. Indulge in our mouth-watering Barbeque dishes that are sure to tantalize your taste buds. Our late-night car dining services are designed to offer you the convenience of enjoying our delicious food right from the comfort of your vehicle.
            </p>
            <p>
              Savor tasty food with your loved ones while soaking in the good ambience of our vibrant atmosphere. Whether it's a late-night craving or a fun outing, Firangi Barbeque 2.0 is here to make your dining experience unforgettable.
            </p>
          </div>
